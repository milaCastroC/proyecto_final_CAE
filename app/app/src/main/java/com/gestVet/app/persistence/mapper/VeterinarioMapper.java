...
public interface VeterinarioMapper {
    ...
    @Mapping(target = "citas", ignore = true) // No está en el DTO
    @Mapping(target = "veterinarioHorarios", ignore = true) // No está en el DTO
    ...
    @Mapping(target = "citas", ignore = true) // No se mapea desde el DTO
    @Mapping(target = "veterinarioHorarios", ignore = true) // No se mapea desde el DTO
